...
cat("Normal component 1 - Features with high stability: ", stab.normal.c1, "- Mean stability: ", mean(perf.splsda.srbct.normal$features$stable[[1]]))
cat("Normal component 2 - Features with high stability: ", stab.normal.c2, "- Mean stability: ", mean(perf.splsda.srbct.normal$features$stable[[2]]))
cat("Normal component 3 - Features with high stability: ", stab.normal.c3, "- Mean stability: ", mean(perf.splsda.srbct.normal$features$stable[[3]]))

cat("Permutted component 1 - Features with high stability: ", stab.permuted.c1, "- Mean stability: ", mean(perf.splsda.srbct.permuted$features$stable[[1]]))
cat("Permutted component 2 - Features with high stability: ", stab.permuted.c2, "- Mean stability: ", mean(perf.splsda.srbct.permuted$features$stable[[2]]))
cat("Permutted component 3 - Features with high stability: ", stab.permuted.c3, "- Mean stability: ", mean(perf.splsda.srbct.permuted$features$stable[[3]]))
```
