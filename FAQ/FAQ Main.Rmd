...
#### **When running `rcc()`, I have run into the following error:**
...
- 1. [rCCA Methods page](http://mixomics.org/methods/rcca/)
- 2. [(s)PLS Methods page](http://mixomics.org/methods/spls/)
...
#### **What does the error `system is computationally singular` mean when undergoing (s)PLS-DA?**
...
- 1. [Missing Values Page](http://mixomics.org/methods/missing-values/)
